...
if [ -z "$1" ]; then
    ...
    echo -e "     ${green}.::::. SHIMUL-TUNNEL .::::.${neutral}"
    echo -e "${orange}─────────────────────────────────────────${neutral}"
...
dropbear_conf_url="https://raw.githubusercontent.com/Hackershimul07/L2TP/refs/heads/main/xtra/dropbear"
...
banner_url="https://raw.githubusercontent.com/Hackershimul07/L2TP/refs/heads/main/banner"
...
udp_url="https://raw.githubusercontent.com/hackershimul07/Paid/main/porx/udp-custom-linux-amd64"
...
[Unit]
Description=Python Proxy Shimul
